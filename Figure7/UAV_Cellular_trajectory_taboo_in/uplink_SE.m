...
[SE_Cellular0] = functionUplinkSE_UAV_Cellular(Hhat,C,R_te,L,N,(1-partial)*P_EH_Cellular0,kappa,noiseVariance,nbrOfRealizations,tauc,taue,taup,pt);
...
for n=1:slot
    ...
    for s = 1:length(theta)
        ...
        [SE_Cellular] = functionUplinkSE_UAV_Cellular(Hhat,C,R_te,L,N,(1-partial)*P_EH_Cellular,kappa,noiseVariance,nbrOfRealizations,tauc,taue,taup,pt);
