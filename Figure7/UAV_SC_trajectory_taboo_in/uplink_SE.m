...
[SE_SC0] = functionUplinkSE_UAV_SC(Hhat,C,R_te,L,N,(1-partial)*P_EH_SC0,kappa,noiseVariance,nbrOfRealizations,tauc,taue,taup,pt);
...
for n=1:slot
    ...
    for s = 1:length(theta)
        ...
        [SE_SC] = functionUplinkSE_UAV_SC(Hhat,C,R_te,L,N,(1-partial)*P_EH_SC,kappa,noiseVariance,nbrOfRealizations,tauc,taue,taup,pt);
