...
for r = 1:setups
    ...
    [SE_Cellular0] = functionUplinkSE_UAV_Cellular(Hhat,C,L,N,(tauc/(tauc-taup-taue))*(1-partial)*P_EH_Cellular0,kappa,noiseVariance,nbrOfRealizations,tauc,taue,taup);
