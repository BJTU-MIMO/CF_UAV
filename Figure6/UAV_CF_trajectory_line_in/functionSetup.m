function [R,R_te,HMean,H,HMeanx,H_Rayleigh,channelGain] = functionSetup(L,N,ASD,nbrOfRealizations,APpositions,UEpositions,UEpositions_te,APheigth,UEheigth)
