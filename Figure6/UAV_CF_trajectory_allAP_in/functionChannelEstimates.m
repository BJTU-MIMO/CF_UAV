function [Hhat,Q,C,Psi,G_te] = functionChannelEstimates(R,R_te,HMean,H,HMeanx,L,N,nbrOfRealizations,p,kappa,noiseVariance,pt)
...
G_te = zeros(N,N,L);
    ...
    for l=1:L
        ...
        Psi_te(:,:,l) = (pt*R_te(:,:,l)+sigma2*eye(N))^(-1);
        G_te(:,:,l) = pt*R_te(:,:,l)*Psi_te(:,:,l)*R_te(:,:,l);
    end
