...
[P_EH_CF0] = functionDownlinkEH_UAV_CF(R,Q,G_te,HMean,L,pd,kappa,tauc,taue);
[SE_CF0] = functionUplinkSE_UAV_CF(R,Q,R_te,HMean,L,(1-partial)*P_EH_CF0,kappa,noiseVariance,tauc,taue,taup,pt);
...
for n=1:slot
    ...
    for s = 1:length(theta)
        ...
        [SE_CF] = functionUplinkSE_UAV_CF(R,Q,R_te,HMean,L,(1-partial)*P_EH_CF,kappa,noiseVariance,tauc,taue,taup,pt);
