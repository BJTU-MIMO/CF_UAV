...
for n=1:nbrOfSetups  
     ...
     [P_EH_SC0] = functionDownlinkEH_UAV_SC(R,Q0,HMean,L,pd,kappa,tauc,taue);
     
     [Hhat,Q,C,Psi] = functionChannelEstimates(R,HMean,H,HMeanx,L,N,nbrOfRealizations,((tauc/taup)*partial*P_EH_SC0),kappa,noiseVariance);
