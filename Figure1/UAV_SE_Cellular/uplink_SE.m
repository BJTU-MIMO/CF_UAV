...
for n=1:nbrOfSetups  
     ...
     [P_EH_Cellular0] = functionDownlinkEH_UAV_Cellular(R,Q0,G_te0,HMean,L,pd,kappa,tauc,taue);
     
     [Hhat,Q,C,Psi,G_te] = functionChannelEstimates(R,R_te,HMean,H,HMeanx,L,N,nbrOfRealizations,((tauc/taup)*partial*P_EH_Cellular0),kappa,noiseVariance,pt);
